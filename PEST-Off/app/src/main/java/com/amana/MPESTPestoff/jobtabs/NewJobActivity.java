...
import com.amana.MPESTPestoff.adapter.MyPagerAdapter;
import com.amana.MPESTPestoff.components.LockableViewPager;
...
public class NewJobActivity extends AppCompatActivity {
    ...
    private String[] arr_title = {"Services","Feedback","Infestation Level","Payment","End Service"};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            startActivity(new Intent(NewJobActivity.this, DashboardActivity.class));
            finish();
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(NewJobActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(NewJobActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
