package com.amana.MPESTPestoff.restApi;

import com.amana.MPESTPestoff.model.ADHOCUploadRequest;
import com.amana.MPESTPestoff.model.ADHOCUploadRequestWithID;
import com.amana.MPESTPestoff.model.AdhocRequest;
import com.amana.MPESTPestoff.model.UploadRequest;
import com.amana.MPESTPestoff.model.checkinout.CheckingRequest;
import com.amana.MPESTPestoff.model.checkinout.CheckingResponse;
import com.amana.MPESTPestoff.model.comments.CommetsResponse;
import com.amana.MPESTPestoff.model.customerlist.CustomersListResponse;
import com.amana.MPESTPestoff.model.login.LoginApiRequest;
import com.amana.MPESTPestoff.model.login.LoginApiResponse;
...
import com.amana.MPESTPestoff.model.pesttype.PesttypeResponse;
...
public interface ApiInterface {
    ...
    //Global URl
    //UAT
    String BASE_URL = "http://www.amanaasia.net:3002/";// UAT
    String REPORT_URL = "http://www.amanaasia.net:8080/PestOff.Reports/Reports/CompletedEmailServiceReport.aspx?ID="; //' + SERVICE_ID + '&Type=Download';

    // String REPORT_URL = "http://www.amanaasia.net:8080/MPESTPestoff.Reports/Reports/";
