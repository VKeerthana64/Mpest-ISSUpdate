...
*/
          ...
          /*  addressDetails.append("Postal Code: ");
            ...
            sendResultsToReceiver(2,addressDetails.toString(),address.getPostalCode());
        }
    }
    //to send results to receiver in the source activity
    private void sendResultsToReceiver(int resultCode, String message,String PostalCode) {
