...
import com.amana.MPESTRidpest.comments.CommentsActivity;
import com.amana.MPESTRidpest.dashboard.DashboardActivity;
import com.amana.MPESTRidpest.myjob.MyJobActivity;
import com.amana.MPESTRidpest.myjob.PreviewActivity;
import com.amana.MPESTRidpest.myjob.ServiceDetailsActivity;
        ...
        if (datum.getStatus().toString().trim().equalsIgnoreCase("In-Progress")) {
            ...
            try{
                ...
                if (!TextUtils.isEmpty(datum.getUploadStatus().toString()) && datum.getUploadStatus().toString().contains("Upload")) {
                    ...
                    if(datum.getUploadStatus().toString().equalsIgnoreCase("Upload Inprocess")){
