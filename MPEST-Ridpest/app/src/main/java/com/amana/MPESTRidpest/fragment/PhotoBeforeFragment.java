package com.amana.MPESTRidpest.fragment;
...
import com.amana.MPESTRidpest.adapter.DocsDataDisplayAdapter;
import com.amana.MPESTRidpest.adapter.FragmentLifecycle;
import com.amana.MPESTRidpest.adapter.PestAdapter;
import com.amana.MPESTRidpest.adapter.PhotoAdapter;
import com.amana.MPESTRidpest.components.MultiSelectionSpinner;
import com.amana.MPESTRidpest.model.PestModel;
import com.amana.MPESTRidpest.model.RemarskModel;
import com.amana.MPESTRidpest.model.realm.jobdetails.PhotoRemarkRMModel;
import com.amana.MPESTRidpest.myjob.MyJobActivity;
import com.amana.MPESTRidpest.utils.AppConstants;
...
import com.amana.MPESTRidpest.utils.PermissionUtils;
...
public class PhotoBeforeFragment extends Fragment implements FragmentLifecycle, PhotoAdapter.ItemClickListener, PestAdapter.ItemClickListener, MultiSelectionSpinner.OnMultipleItemsSelectedListener, DocsDataDisplayAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        ...
        updatePhotoList("BEFORE", str_pestType);
    ...
    private void init() {
               ...
               Retropicker.Builder builder =  new Retropicker.Builder(getActivity())
                ...
                builder.enquee(new CallbackPicker() {
                    ...
                    public void onSuccess(Bitmap bitmap, String imagePath) {
                        ...
                        MasterDbLists.saveImageDetails("BEFORE",str_pestType,_appPrefs.getSERVICEID().toString(),imagePath);
                        updatePhotoList("BEFORE",str_pestType);
                ...
                builder.enquee(new CallbackPicker() {
                    ...
                    public void onSuccess(Bitmap bitmap, String imagePath) {
                        ...
                        if(imgFile.exists()){
                            ...
                            MasterDbLists.saveImageDetails("BEFORE",str_pestType,_appPrefs.getSERVICEID().toString(),path);
                            updatePhotoList("BEFORE",str_pestType);
                            photoAdapter.notifyDataSetChanged();
        ...
        bn_Proceed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MyJobActivity) getActivity()).switchFragment(1);
...
*/
            String path = Environment.getExternalStorageDirectory()
                    + "/Android/data/CLEANSolutions/profile/IMG_" + Calendar.getInstance().getTimeInMillis();
...
*/
    private void onActivityResultOfCameraCapture(Intent data) {
        ...
        if(imgFile.exists()){
                ...
                MasterDbLists.saveImageDetails("BEFORE",str_pestType,_appPrefs.getSERVICEID().toString(),selectedImage.getPath());
                updatePhotoList("BEFORE",str_pestType);
                photoAdapter.notifyDataSetChanged();
