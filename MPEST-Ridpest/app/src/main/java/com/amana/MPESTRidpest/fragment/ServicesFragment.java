...
public class ServicesFragment extends Fragment implements FragmentLifecycle,PestAdapter.ItemClickListener {
    ...
    private void init() {
        ...
        edt_services.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MasterDbLists.UpdateServiceMaterialRemarks(_appPrefs.getSERVICEID(), "SERVICE", str_pestType, edt_others.getText().toString()); // insert/update data in Realm
    ...
    private void updatePestType() {
        ...
        for (int i = 0; arrayString.length > i; i++) {
            ...
            MasterDbLists.saveServiceDetailsInDb(getActivity(), arrayString[i], "SERVICE", _appPrefs.getSERVICEID().toString());
        }
    ...
    private void getMaterialsList(String mType, String mPestType) { // mType service or Materials
        ...
        if (arr_ServiceSelectedList != null) {
            ...
            edt_services.setText(arr_ServiceSelectedList.getSM_remarks());
                ...
                .onSubmit(new MultiSelectDialog.SubmitCallbackListener() {
                    ...
                    public void onSelected(ArrayList<Integer> selectedIds, ArrayList<String> selectedNames, String dataString) {
                        ...
                        if (mSelected.length() > 0) {
                            ...
                            MasterDbLists.UpdateServiceMaterialRemarks(_appPrefs.getSERVICEID(), "SERVICE", str_pestType, mSelected, arr_SelectedList, edt_others.getText().toString());
    ...
    public void savefieldDetails(String str_pestType) {
      ...
      /*  if (str_pestType.equalsIgnoreCase("BIRDS")) {
        ...
        MasterDbLists.UpdateServiceMaterialRemarks(_appPrefs.getSERVICEID(), "SERVICE", str_pestType, servicesCapturesRmModels);
    }
    ...
    public void onPestItemClick(View view, int position) {
        ...
        MasterDbLists.UpdateServiceMaterialRemarks(_appPrefs.getSERVICEID(), "SERVICE", str_pestType, edt_others.getText().toString());
        savefieldDetails(str_pestType);
