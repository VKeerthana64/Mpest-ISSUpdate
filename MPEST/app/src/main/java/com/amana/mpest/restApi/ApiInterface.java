package com.amana.mpest.restApi;

import com.amana.mpest.model.ADHOCUploadRequest;
import com.amana.mpest.model.ADHOCUploadRequestWithID;
import com.amana.mpest.model.AdhocRequest;
import com.amana.mpest.model.UploadRequest;
import com.amana.mpest.model.checkinout.CheckingRequest;
import com.amana.mpest.model.checkinout.CheckingResponse;
import com.amana.mpest.model.comments.CommetsResponse;
import com.amana.mpest.model.customerlist.CustomersListResponse;
import com.amana.mpest.model.login.LoginApiRequest;
import com.amana.mpest.model.login.LoginApiResponse;
...
import com.amana.mpest.model.pesttype.PesttypeResponse;
import com.amana.mpest.model.schedule.ScheduleResponse;
...
public interface ApiInterface {
    ...
    //Global URl
    //UAT,.
    String BASE_URL = "http://www.amanaasia.net:3306/";// UAT
    String REPORT_URL = "http://www.amanaasia.net:8080/MPest.Reports/Reports/CompletedEmailServiceReport.aspx?ID="; //' + SERVICE_ID + '&Type=Download';

    // String REPORT_URL = "http://www.amanaasia.net:8080/mpest.Reports/Reports/";
   ...
   // String BASE_URL = "http://104.215.149.183:84/";// Production
    ...
    String POST_SCHEDULER = "scheduler/getforMobile";  //  getforMobile
