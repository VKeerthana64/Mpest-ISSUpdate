...
public interface ApiInterface {
    ...
    String REPORT_URL = "https://www.amanaasia.net/ISS.Reports/Reports/CompletedEmailServiceReport.aspx?ID=";

    //' + SERVICE_ID + '&Type=Download';
...
//    String REPORT_URL = "https://mpest.isssg.biz/ISS.Reports/Reports/CompletedEmailServiceReport.aspx?ID=";

//    String BASE_URL = "https://mpest.isssg.biz:96/";// prod
//    String REPORT_URL = "https://mpest.isssg.biz/ISSTraining.Reports/Reports/CompletedEmailServiceReport.aspx?ID=";
    ...
    String POST_FINDING = "finding";
    String POST_RECOMMENDATION = "recommendation";
    ...
    @FormUrlEncoded
    @POST(BASE_URL + POST_FINDING)
    Call<FindingData> getFinding(@Field("Client_Id") String Client_Id);

    @FormUrlEncoded
    @POST(BASE_URL + POST_RECOMMENDATION)
    Call<RecommendationData> getRecommendation(@Field("Client_Id") String Client_Id);
    ...
    Call<Object> JobStatusUpdate(@Field("_id") String _Id,@Field("UpdatedBy") String UpdatedBy, @Field("Status") String mStatus,@Field("AppVersion") String AppVersion,@Field("MobileVersion") String MobileVersion,@Field("Tracking_ID") String Tracking_ID,@Field("CurrentLocation") String CurrentLocation);

    @FormUrlEncoded
    @PUT(BASE_URL + POST_STATUSUPDATE)
    Call<Object> JobStatusUpdates(@Field("_id") String _Id, @Field("Status") String mStatus,@Field("UpdatedBy") String UpdatedBy);
