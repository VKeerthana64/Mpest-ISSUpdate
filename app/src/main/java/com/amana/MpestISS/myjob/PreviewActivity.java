...
//        tv_scheduled_end_time.setText(Utils.CurrentTime());
        ...
        Log.d("asjdajd","xjg" + arr_materialedetail);
        ...
        Log.d("asjdajsdd","xjg" + arr_previewMaterial);
    ...
    class FinalEndService extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute() {
           ...
           // uploadRequest.setScheduledate(Utils.getedDate(mList.get(0).getCreateDate()));
            ...
            uploadRequest.setStartsat(_appPrefs.getJobStartedTime().toString());
//            uploadRequest.setEndsat(Utils.getCurrentDateTime());
            uploadRequest.setEndsat(_appPrefs.getJobEndedTime().toString());
            uploadRequest.setPesttype(mList.get(0).getPestType());
            uploadRequest.setServices(SelectedServices);
            uploadRequest.setTeamLead(mList.get(0).getTeamdetails().get(0).getTeamLead());
            uploadRequest.setTeamMember(TeamMember);
    ...
    private void fetchAllDetails() {
        ...
        if(paymentCaptureRmModel != null){
            ...
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getServiceCall());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getContinueJob());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getAdhoc());
            Log.d("UUUUUUUUU","cvb" +paymentCaptureRmModel.getAmount());

            Log.d("UUUUUUUUU","cvb" +  paymentCaptureRmModel.getFollowUpDate());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getFollowUpPestType());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getFollowUpServiceArea());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getFollowUpJobNotes());

            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getServiceFollowUpDate());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getServiceFollowUpPestType());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getServiceFollowUpServiceArea());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getServiceFollowUpJobNotes());

            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getCtneFollowUpDate());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getCtneFollowUpPestType());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getCtneFollowUpServiceArea());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getCtneFollowUpJobNotes());

            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getAdhocFollowUpDate());
            Log.d("UUUUUUUUU","cvb" +paymentCaptureRmModel.getAdhocFollowUpPestType());
            Log.d("UUUUUUUUU","cvb" +paymentCaptureRmModel.getAdhocFollowUpServiceArea());
            Log.d("UUUUUUUUU","cvb" + paymentCaptureRmModel.getAdhocFollowUpJobNotes());
        }
        ...
        if(arr_servicedetail.size()>0){
            ...
            for(int i= 0; i<arr_servicedetail.size(); i++){
                ...
                if(arr_servicedetail.get(i).getSS_remarks().length() != 0 || arr_servicedetail.get(i).getOthers().length() != 0){
                    ...
                    Log.d("xcvxvasa","cvbcv" +servicesRequest.getPestType());
                    Log.d("xcvxvasa","cvbcv" +servicesRequest.getServices());
                    Log.d("xcvxvasa","cvbcv" +servicesRequest.getFinding());
                    Log.d("xcvxvasa","cvbcv" +servicesRequest.getRecommendation());
    ...
    public void JobStatusUpdate(String _id, String UserID) {
     ...
     /*   try{
        ...
        final ApiInterface apiService =
                ApiClient.getClient().create(ApiInterface.class);
        Call<Object> call = apiService.JobStatusUpdates(_id, "Completed", UserID);
