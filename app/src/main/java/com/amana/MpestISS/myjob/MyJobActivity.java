...
import com.amana.MpestISS.adapter.MyPagerAdapter;
import com.amana.MpestISS.components.LockableViewPager;
...
public class MyJobActivity extends AppCompatActivity {
    ...
    private void init() {
       ...
       Log.d("sdfsdfxvc","Cvb" + _appPrefs.getJobStartedTime().toString());
       Log.d("sdfsdfxvc","Cvb" + _appPrefs.getJobEndedTime().toString());

        if(!(_appPrefs.getJobEndedTime().toString().length() > 0)){
