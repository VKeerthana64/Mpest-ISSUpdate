...
public class PreviewMaterialsAdapter extends RecyclerView.Adapter<PreviewMaterialsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final MaterialPreviewModel materialPreviewModel = getItem(position);
            ...
            holder.txt_dilution.setText(materialPreviewModel.getDilution());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView txt_pestType, txt_material,txt_quantity, txt_unit,txt_dilution;
        ...
        public ViewHolder(View itemView) {
            ...
            txt_dilution = (TextView) itemView.findViewById(R.id.txt_dilution);
