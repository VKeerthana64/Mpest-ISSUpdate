...
public class AppPreferences {
    ...
    public static final String KEY_JOBENDEDTIME = "KEY_JOBENDEDTIME";
    ...
    public String getCheckStatus() {
        return _sharedPrefs.getString(KEY_CHECKSTATUS, "Checked OUT");
    }
    ...
    public String getJobEndedTime() {
        return _sharedPrefs.getString(KEY_JOBENDEDTIME, "");
    }
    ...
    public void saveJobEndedTime(String text) {
        _prefsEditor.putString(KEY_JOBENDEDTIME, text);
        _prefsEditor.commit();
    }
