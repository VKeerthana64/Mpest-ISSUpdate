...
public class PreviewServicesAdapter extends RecyclerView.Adapter<PreviewServicesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(serviceMaterialRMModel.getOthers().length() >0 && serviceMaterialRMModel.getSM_remarks().length() > 0){
            holder.txt_service.setText(serviceMaterialRMModel.getSM_remarks()+","+serviceMaterialRMModel.getOthers());
        }else if(serviceMaterialRMModel.getOthers().length() ==0 && serviceMaterialRMModel.getSM_remarks().length() > 0) {
            holder.txt_service.setText(serviceMaterialRMModel.getSM_remarks());
        }else if(serviceMaterialRMModel.getOthers().length() >0 && serviceMaterialRMModel.getSM_remarks().length() == 0) {
